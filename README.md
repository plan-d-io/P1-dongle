...
>Currently this is a DIY project. If we detect sufficient interest in this project, we might start offering ready-to-use versions of the dongle for reasonabl prices.
